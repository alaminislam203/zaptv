...
import { Play, Activity, Clock, Globe, AlertTriangle, Search, Filter, ChevronRight, Tv, Newspaper, Trophy, Baby, Music, Star, Zap, Shield } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-emerald-500/30 dark:bg-slate-950 light:bg-slate-50 transition-colors duration-500">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 relative z-10 pb-32">
        ...
        {/* Marquee Notice */}
        <div className="glass rounded-3xl py-5 px-8 mb-16 overflow-hidden relative border-l-8 border-l-emerald-500 shadow-emerald-500/5">
          <div className="flex whitespace-nowrap animate-marquee">
            <span className="text-xs font-black text-slate-400 px-12 flex items-center gap-3 uppercase tracking-[0.2em]">
