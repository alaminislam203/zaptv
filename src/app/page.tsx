...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (counterRef.current) {
        ...
        scriptAuth.src = "https://www.freevisitorcounters.com/auth.php?id=13a66b52026e128ceca0a5684f21439e339d5d99";
        scriptAuth.async = true;

        const scriptCount = document.createElement("script");
        scriptCount.src = "https://www.freevisitorcounters.com/en/home/counter/1461351/t/1";
    ...
    <main className="min-h-screen bg-[#0b1120] text-gray-200 font-sans pb-10">
      ...
      <div className="max-w-4xl mx-auto px-2 md:px-4 mt-4 space-y-4">
        ...
        <div className="bg-[#1e293b] rounded-lg p-3 border border-gray-800 flex flex-col items-center justify-center mb-8 space-y-2">
            ...
            <div ref={counterRef} className="flex flex-col items-center justify-center gap-1">
               <div className="text-xs text-gray-500">Loading Counter...</div>
            </div>
