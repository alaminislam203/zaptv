...
<div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 
  ...
  <Link href="https://t.me/toffeepro">
    <button className="text-xs sm:text-sm bg-blue-600 hover:bg-blue-500 px-3 py-1.5 rounded-md text-white transition whitespace-nowrap">
      Join Telegram
        ...
        <div className="rounded-2xl overflow-hidden bg-black border border-gray-800 shadow-2xl">
  ...
  <div className="bg-gradient-to-r from-slate-950 to-slate-900 
                  border-t border-gray-800 px-3 py-2 
    ...
    {currentChannel?.sources[activeSourceIndex]?.url.includes(".m3u8") &&
      !currentChannel.is_embed && (
        <div className="flex items-center gap-2">
          <span className="hidden sm:block text-gray-500 mr-1">
            Engine
          </span>
          ...
          {[
            ...
            <button
              ...
              className={`px-3 py-1 rounded-full border text-[11px] font-medium transition
                ${
                  playerType === p.id
                    ? "bg-cyan-600/90 border-cyan-500 text-white shadow"
    ...
    <div className="ml-auto flex items-center gap-2">
      ...
      <button
        ...
        className="px-3 py-1 rounded-full bg-gray-800/60 
      ...
      <button
        ...
        className={`px-3 py-1 rounded-full bg-gray-800/60 transition
          ${
            isFavorite
